            ...
            conversations.map((conv) => {
              ...
              return (
                <button
                  ...
                  className={`w-full text-left flex items-center p-4 space-x-3 cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-colors border-l-4 ${String(currentConversation) === String(otherUser._id) ? 'border-red-500 bg-slate-50 dark:bg-slate-900/50' : 'border-transparent'
                    }`}
                >
